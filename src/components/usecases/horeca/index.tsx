    ...
    return (
        <>
            ...
            <div className="horeca">
                <div className="horeca__content">
                    <div className="horeca__content--header active reveal fade-bottom">
                    ...
                    <div className="reveal active fade-bottom">
                        <div className="horeca__content--title">
                            Casa
                        </div>
                        <img className="horeca__content--image horeca__content--image--left" src={casa1} alt="Logo" />
                        <div className="horeca__content--text">
                    ...
                    <div className="reveal fade-bottom">
                        <img className="horeca__content--image horeca__content--image--right" src={casa2} alt="Logo" />
                        <div className="horeca__content--text">
                            &emsp;&emsp;Tale complesso si rivela, a contatto con microrganismi patogeni, come efficace “antagonista batterico”.
                            La duplicazione esponenziale delle colonie batteriche generate viene favorita dalla catalizzazione enzimatica, che assicura una rapida reazione biochimica rivolta alla degradazione della sostanza organica,
                            con conseguente inibizioTale complesso si rivela, a contatto con microrganismi patogeni, come efficace “antagonista batterico”.
                    ...
                    <div className="reveal fade-bottom">
                        ...
                        <img className="horeca__content--image horeca__content--image--right" src={casa3} alt="Logo" />
                        <div className="horeca__content--text">
                            &emsp;&emsp;Tale complesso si rivela, a contatto con microrganismi patogeni, come efficace “antagonista batterico”.
                            La duplicazione esponenziale delle colonie batteriche generate viene favorita dalla catalizzazione enzimatica, che assicura una rapida reazione biochimica rivolta alla degradazione della sostanza organica,
                            con conseguente inibizioTale complesso si rivela, a contatto con microrganismi patogeni, come efficace “antagonista batterico”.
                    ...
                    <div className="reveal fade-bottom">
                        <img className="horeca__content--image horeca__content--image--left" src={casa4} alt="Logo" />
                        <div className="horeca__content--text">
